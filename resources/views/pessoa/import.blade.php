        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="mx-5 my-5 text-gray-900 dark:text-gray-100 space-y-3">
                    ...
                    <x-biz.flash-message />
                    <h3 class="text-xl font-medium text-gray-800 dark:text-gray-200">Importar Pessoas</h3>

                    <form action="{{ route('pessoas.process-import') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-4 space-y-1">
                            <x-label for="image">Escolha arquivo Excel com relatório de pessoas.</x-label>
